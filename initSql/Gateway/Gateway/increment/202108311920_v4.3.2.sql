...
CREATE TABLE if not exists `gw_api_group` (
`id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE if not exists `gw_invoke_count` (
...
CREATE TABLE if not exists `gw_invoke_log` (
...
CREATE TABLE if not exists `gw_statistics_trigger` (
 `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE if not exists `gw_snapshot_api` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE if not exists `gw_snapshot_invoke` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`api_id` int(11) NOT NULL,
`app_type` tinyint(2) NOT NULL COMMENT '平台应用类型',
`group_id` int(11) DEFAULT NULL COMMENT '对应gw_api_group id',
...
CREATE TABLE if not exists `gw_invoke_count_day` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
`app_type` tinyint(2) NOT NULL COMMENT '平台应用类型',
...
CREATE TABLE if not exists `gw_snapshot_err` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`api_id` int(11) NOT NULL,
`app_type` tinyint(2) NOT NULL COMMENT '平台应用类型',
