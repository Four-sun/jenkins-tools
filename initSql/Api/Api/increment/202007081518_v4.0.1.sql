...
-- 增加缓存相关字段
ALTER TABLE da_api ADD COLUMN `is_cache` tinyint(1) DEFAULT '0' COMMENT '是否缓存';
ALTER TABLE da_api ADD COLUMN `cache_expiry_period` int(11) DEFAULT NULL COMMENT '缓存失效周期，1-分，2-时，3-天，4-周，5-月';
ALTER TABLE da_api ADD COLUMN `cache_expiry_date_cron` varchar(255) DEFAULT NULL COMMENT '缓存失效时间的cron表达式';

ALTER TABLE da_api_test ADD COLUMN `is_cache` tinyint(1) DEFAULT '0' COMMENT '是否缓存';
ALTER TABLE da_api_test ADD COLUMN `cache_expiry_period` int(11) DEFAULT NULL COMMENT '缓存失效周期，1-分，2-时，3-天，4-周，5-月';
ALTER TABLE da_api_test ADD COLUMN `cache_expiry_date_cron` varchar(255) DEFAULT NULL COMMENT '缓存失效时间的cron表达式';

-- 增加是否忽略语法校验字段
ALTER TABLE da_api ADD COLUMN `is_ignore_syntax_check` tinyint(1) DEFAULT '0' COMMENT '是否忽略语法校验';
ALTER TABLE da_api_test ADD COLUMN `is_ignore_syntax_check` tinyint(1) DEFAULT '0' COMMENT '是否忽略语法校验';