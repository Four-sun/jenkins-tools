...
VALUES
('stream', '*/10 * * * * ?', 'streamAlarmJob', 'StreamAlarmJobGroup', 'StreamAlarmTrigger', 'StreamAlarmTriggerGroup', 'com.dtstack.streamapp.service.schedule.StreamAlarmJob', '0', null, null, now(), now(), '0'),
('stream', '0 */10 * * * ?', 'streamDataSourceJob', 'streamDataSourceJob', 'streamDataSourceJobTrigger', 'streamDataSourceJobTriggerGroup', 'com.dtstack.streamapp.service.schedule.StreamDataSourceJob', '0', null, null, now(), now(), '0'),
('stream', '0 0/1 * * * ?', 'streamStrategyJob', 'streamStrategyJob', 'streamStrategyJobTrigger', 'streamStrategyJobTriggerGroup', 'com.dtstack.streamapp.service.schedule.StreamStrategyJob', '0', null, null, now(), now(), '0');