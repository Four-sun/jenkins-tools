...
# 利用Graphviz进行二叉树的可视化
# tree.print_tree(save_path='/Users/four/Downloads/four_git/jenkins-tools/jenkins-tools/DtBatchApp/create_btree_by_list.gv', label=True)