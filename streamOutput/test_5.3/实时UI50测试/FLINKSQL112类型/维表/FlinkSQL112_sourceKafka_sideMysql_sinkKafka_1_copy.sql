...
[{"sourceId":"185","cacheTTLMs":"60000","cache":"LRU","keyField":["id"],"cacheSize":"10000","columns":[{"column":"id","type":"INT"},{"column":"name","type":"VARCHAR"},{"column":"channel","type":"VARCHAR"},{"column":"time_info","type":"VARCHAR"},{"column":"flag","type":"VARCHAR"}],"parallelism":1,"createType":0,"type":1,"tableName":"mysqlSideTable","sourceName":"mysql_auto_test","asyncPoolSize":5,"table":"threedimjoin_sidetabletwo","primaryKey":["id"]},{"sourceId":"361","cacheTTLMs":"60000","cache":"ALL","keyField":["id","name"],"cacheSize":"10000","columns":[{"column":"id","type":"INT"},{"column":"name","type":"VARCHAR"},{"column":"channel","type":"VARCHAR"},{"column":"time_info","type":"VARCHAR"},{"column":"flag","type":"VARCHAR"}],"errorLimit":100,"parallelism":1,"createType":0,"type":1,"tableName":"mysqlSideTableOne","sourceName":"mysql_automation","asyncPoolSize":4,"table":"threedimjoin_sidetablethree","primaryKey":["id","name"]},{"sourceId":"361","cacheTTLMs":"60000","cache":"None","keyField":["id"],"cacheSize":"10000","columns":[{"column":"id","type":"INT"},{"column":"name","type":"VARCHAR"},{"column":"channel","type":"VARCHAR"},{"column":"time_info","type":"VARCHAR"},{"column":"flag","type":"VARCHAR"}],"errorLimit":100,"parallelism":1,"createType":0,"type":1,"tableName":"mysqlSideTableTwo","sourceName":"mysql_automation","asyncPoolSize":5,"table":"threedimjoin_sidetablethree","primaryKey":["id"]}]
...
CREATE TABLE mysqlSideTableOne(
    id INT,
    name VARCHAR,
    channel VARCHAR,
    time_info VARCHAR,
...
CREATE TABLE mysqlSideTableTwo(
    id INT,
    name VARCHAR,
    channel VARCHAR,
    time_info VARCHAR,
...
INTO
    ...
    from
        sourceTableOne st     
    left join
        mysqlSideTableOne for SYSTEM_TIME as of st.proc_time as mst              
            on st.id = mst.id;
INSERT  
INTO
    kafkaResultTableTwo
    ...
    from
        sourceTableTwo st     
    left join
        mysqlSideTableTwo for SYSTEM_TIME as of st.proc_time as mst              
            on st.id = mst.id;
